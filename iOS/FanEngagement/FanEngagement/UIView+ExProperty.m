...
@dynamic hexTextColor, hexPlaceholderColorString;
...
- (void)setHexPlaceholderColorString:(NSString *)hexPlaceholderColorString {
    if (hexPlaceholderColorString == nil || hexPlaceholderColorString.length == 0) return;
    
    NSArray *array = [hexPlaceholderColorString componentsSeparatedByString:@"-"];
